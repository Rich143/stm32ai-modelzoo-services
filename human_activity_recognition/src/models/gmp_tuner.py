...
def create_build_model(input_shape: tuple[int] = (24, 3, 1),
    ...
    def build_model(hp):
        ...
        model = get_gmp(input_shape=input_shape, num_classes=num_classes, dropout=dropout, num_conv_layers=num_conv_layers)
...
def get_gmp(input_shape: tuple[int] = (24, 3, 1),
    ...
    for _ in range(num_conv_layers):
        ...
        model.add(layers.Conv2D(16, kernel_size=(5, 1), strides=(1, 1),
